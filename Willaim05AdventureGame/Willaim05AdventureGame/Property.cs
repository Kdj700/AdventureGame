...
namespace Willaim05AdventureGame
{
    public class Property
    {
        ...
        public Property(string playerNameCreate, int cookingAgeCreate)
        {
            playerName = playerNameCreate;
            cookingAge = cookingAgeCreate;
            taste = 0;
            appearance = 0;
            aroma = 0; 
        }
        ...
        public void playerInfo()
        {
            ...
            Console.WriteLine("Your cooking age is:" + this.cookingAge);
